"""
ResNeSt-101 model module for skin lesion classification.
"""
...
class SkinLesionResNeSt101Classifier(nn.Module):
    """
    ResNeSt-101 based classifier for skin lesion classification.

    This model uses a pretrained ResNeSt-101 backbone with a custom
    ...
    def __init__(
        ...
        """
        Initialize the skin lesion classifier with ResNeSt-101 backbone.
        ...
        # Load pretrained backbone (ResNeSt-101)
    ...
    def _create_backbone(self, pretrained: bool) -> Tuple[nn.Module, int]:
        """Create the ResNeSt-101 backbone."""
    ...
    def _freeze_layers(self, num_layers: int) -> None:
        ...
        For ResNeSt, this freezes stages in order: stem, layer1, layer2, layer3, layer4.
        """
        stage_modules = [
            self.backbone.conv1,
            self.backbone.bn1,
...
def create_model_resnest101(
    ...
    """Factory function to create a ResNeSt-101 skin lesion classifier."""
    return SkinLesionResNeSt101Classifier(
